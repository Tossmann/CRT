...
public class Power {
    ...
    public BigInteger calculate(BigInteger basis, BigInteger exponent) {
        ...
        System.out.println("Basis: " + basis + " Exponent: " + exponent);
        calculateOptimizedPower();
        System.out.println("Result: " + currentValue);
        System.out.println("Needed: " + multiplikationsCounter + " Multiplikations");
        return currentValue;
    }
    ...
    private void multiplikateExponent (int index) {
        ...
        currentValue = currentValue.multiply(correspondingValues.get(index));
    }
}
